<?php
$SITE_INFO_LOCAL_ROOT="C:\\xampp\\htdocs\\frometou\\web\\"; //set to your local path to website
$SITE_INFO_PUBLIC_ROOT="http://localhost/frometou/web/"; //set to you public facing url

//NOTICE!!!! No slash on the end
$SITE_INFO_LOCAL_UPLOADS=$SITE_INFO_LOCAL_ROOT."files";
$SITE_INFO_PUBLIC_UPLOADS=$SITE_INFO_PUBLIC_ROOT."files";
